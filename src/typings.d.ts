...
interface WebpackModule {
    hot: {
        data?: any,
        idle: any,
        accept(dependencies?: string | Array<string>, callback?: (updatedDependencies?: any) => void): void;
        decline(deps?: any | string | Array<string>): void;
        dispose(callback?: (data?: any) => void): void;
        addDisposeHandler(callback?: (data?: any) => void): void;
        removeDisposeHandler(callback?: (data?: any) => void): void;
        check(autoApply?: any, callback?: (err?: Error, outdatedModules?: Array<any>) => void): void;
        apply(options?: any, callback?: (err?: Error, outdatedModules?: Array<any>) => void): void;
...
interface WebpackRequire {
    ...
    ensure(ids: Array<string>, callback: (req: WebpackRequire) => void, chunkName?: string): void;
